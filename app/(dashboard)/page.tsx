...
export default function Home() {
  ...
  return (
    <div
      className="w-full relative flex-1 min-h-screen flex flex-col items-center bg-gradient-to-br
    ...
    >
      ...
      <div className="space-y-3 w-full max-w-7xl mx-auto">
        ...
        <div className="text-center mt-5">
          <h1 className="text-[2.5rem] md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-[#070D1B] tracking-[-0.8px]">
            AI Job Insight
            <span className="relative inline-block pl-3 sm:pl-5">
              <div className="absolute -right-2 top-0 w-[180px] md:w-[220px] lg:w-[270px] h-[50px] sm:h-14 lg:h-16 bg-primary rotate-2 rounded-lg z-10"/>
